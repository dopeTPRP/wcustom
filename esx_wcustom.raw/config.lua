...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = 135.9895, y = -3031.6775, z = 7.0421},
	...
	ls2 = {
		Pos   = { x = 145.0945, y = -3031.0417, z = 7.0380},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	-- ls3 = {
		-- Pos   = { x = 897.7498, y = -2126.6768, z = 30.5586},
		-- Size  = {x = 3.0, y = 3.0, z = 0.2},
		-- Color = {r = 204, g = 204, b = 0},
		-- Marker= 1,
		-- Name  = _U('blip_name'),
	...
	-- ls4 = {
		-- Pos   = { x = 909.2006, y = -2127.9946, z = 30.5586},
		-- Size  = {x = 3.0, y = 3.0, z = 0.2},
		-- Color = {r = 204, g = 204, b = 0},
		-- Marker= 1,
		-- Name  = _U('blip_name'),
	...
	-- ls5 = {
		-- Pos   = { x = 890.5879, y = -2112.1152, z = 30.4595},
		-- Size  = {x = 3.0, y = 3.0, z = 0.2},
		-- Color = {r = 204, g = 204, b = 0},
		-- Marker= 1,
		-- Name  = _U('blip_name'),
